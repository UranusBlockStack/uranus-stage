<template>
    <section class="forgetPwd">
        ...
        <div class="forgetPwdContent">
            <div class="btnChoose">
                <div class="btnMail" @click="chooseMail"><span :class="{chooseBtn:!phoneShow}">邮箱重置密码</span></div>
                <div class="btnPhone" @click="choosePhone"><span :class="{chooseBtn:phoneShow}">手机号重置密码</span></div>
            </div>
