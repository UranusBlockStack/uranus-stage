<template>
    <section class="register">
        ...
        <div class="registerContent">
            <div class="btnChoose">
                <div class="btnMail" @click="chooseMail"><span :class="{chooseBtn:!phoneShow}">{{$t('userCommon.EmailRegister')}}</span>
                </div>
                <div class="btnPhone" @click="choosePhone"><span :class="{chooseBtn:phoneShow}">{{$t('userCommon.mobileRegister')}}</span>
                </div>
            </div>
            ...
            <button class="getCode" :class="{disabledGet: !this.canClick}" @click="countDown(content)">{{content}}</button>
